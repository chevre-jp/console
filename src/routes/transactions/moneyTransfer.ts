...
moneyTransferTransactionsRouter.get(
    ...
    async (req, res, next) => {
        try {
            ...
            const searchConditions: chevre.factory.transaction.ISearchConditions<chevre.factory.transactionType.MoneyTransfer> = {
            ...
            } else if (req.query.format === chevre.factory.chevre.encodingFormat.Text.csv) {
                throw new chevre.factory.errors.NotImplemented();
            } else if (req.query.format === chevre.factory.chevre.encodingFormat.Application.json) {
                throw new chevre.factory.errors.NotImplemented();
            } else {
...
moneyTransferTransactionsRouter.get(
    ...
    async (req, res) => {
        try {
            ...
            const actionsOnTransaction = await moneyTransferService.searchActionsByTransactionId({
                id: transaction.id,
                sort: { startDate: chevre.factory.sortType.Ascending }
            });
